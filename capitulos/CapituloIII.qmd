...
#| message: false
#| warning: false
#| fig-cap: "Distribución de la superficie agraria y número de unidades de producción agropecuaria por tamaño en Sierra y Costa, 1954. Fuente: Elaboración propia a partir de INEC, Censo Agropecuario de 1954."
#| fig-align: center
#| fig-width: 7
#| fig-height: 3.8
...
#| message: false
#| warning: false
#| fig-cap: "Superficie agraria controlada y porcentaje de unidades de producción agropecuaria según tamaño de UPA. Fuente: Elaboración propia a partir de INEC, Censo Agropecuario de 2000."
#| fig-align: center
#| fig-width: 7
#| fig-height: 3.2
...
#| message: false
#| warning: false
#| fig-cap: "Distribución de la superficie agraria y de las unidades de producción agropecuaria según tamaño de explotación en Ecuador. Fuente: Elaboración propia a partir de Salgado (2022)."
#| fig-align: center
#| fig-width: 7
#| fig-height: 4.2
...
Comparado con el último Censo Agropecuario de 2000, los datos de la Encuesta de Superficie y Producción Agropecuaria Continua (ESPAC) correspondientes
...
Así, pese a las diferencias metodológicas entre un censo exhaustivo y una encuesta representativa, el contraste entre el último Censo Agropecuario de 2000 (ver @tbl-calculos-estratos) y las cifras más recientes de la ESPAC revela similitudes estructurales relevantes. No obstante, estas coincidencias deben interpretarse con cautela, dado que mientras el Censo constituye un levantamiento exhaustivo de las unidades de producción agropecuaria, la ESPAC se basa en un diseño muestral y, por tanto, sus resultados corresponden a estimaciones estadísticas. Aun así, ambas fuentes narran la misma historia estructural: entre 2000 y 2022 el agro ecuatoriano no transitó hacia una redistribución significativa de la tierra, sino que mantuvo la coexistencia del minifundio fragmentado y la gran propiedad concentrada, configurando un patrón persistente que condiciona la productividad.
