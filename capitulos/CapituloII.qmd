...
Sobre esta base constitucional se promulgó la LOTRTA en 2016, la cual desarrolla principios clave en torno a la redistribución, regulación y gestión de la tierra rural. Entre sus ejes se encuentran la prohibición del latifundio y de la concentración de la tierra, así como la exigencia de que la propiedad rural cumpla una función social y ambiental. La norma establece mecanismos de regulación, afectación y redistribución bajo los supuestos definidos legalmente, sin fijar un techo nacional único de 2.500 hectáreas aplicable a toda propiedad privada rural [@asamblea_nacional_del_ecuador_ley_2016].
...
A nivel general, la productividad expresa la relación entre los resultados obtenidos y los recursos utilizados. No es sinónimo de eficiencia: la productividad es una razón entre producto e insumos, mientras que la eficiencia compara el desempeño observado con una referencia o frontera factible. Un incremento de la productividad puede obtenerse mediante mejoras en los procesos, cambios tecnológicos, una combinación distinta de insumos o un aumento del valor generado con los recursos disponibles [@coll_evaluacion_2000].
...
La frontera de producción de Farrell es un concepto fundamental en la economía de la producción, introducido por John Farrell en 1957. La frontera delimita el máximo producto factible para una combinación dada de insumos y permite evaluar la eficiencia técnica como la proximidad de una unidad productiva a ese límite [@farrell_measurement_1957]. En el planteamiento de Farrell, la eficiencia técnica se distingue de la eficiencia asignativa, que incorpora los precios relativos de los factores; ambas dimensiones pueden combinarse para analizar la eficiencia económica. Este marco sirve de base a métodos posteriores de medición de eficiencia, entre ellos el Análisis Envolvente de Datos (DEA) [@coelli_total_2005].
...
La eficiencia técnica se refiere a la capacidad de una unidad productiva para obtener el máximo producto posible con una cantidad dada de insumos o, de forma equivalente, para utilizar la mínima cantidad de insumos necesaria para alcanzar un nivel determinado de producción [@farrell_measurement_1957]. Esta noción no depende de los precios de los factores y, por tanto, debe distinguirse de la eficiencia asignativa y de la eficiencia de costos. Las mejoras tecnológicas, organizativas y de gestión pueden acercar a una unidad a su frontera factible al permitir un uso más eficaz de los recursos disponibles.
