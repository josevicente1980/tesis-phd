...
Tenencia predominante & \texttt{clase.mayoria} & Categoría con la mayor proporción de superficie: arrendamiento/aparcería, propiedad o tenencia especial. \\
Superficie total & \texttt{superficie\_total\_z} & Área total utilizada por la especificación, estandarizada mediante puntuación z. \\
...
Educación & \texttt{educacion\_z} & Nivel educativo ordinal, estandarizado. \\
...
$$
\begin{aligned}
\ln(1+Y_i)={}&\beta_0+\beta_1 Tenencia_i+\beta_2 Superficie_{zi}
+\beta_3 Edad_{zi}\\
&+\beta_4 Internet_i+\beta_5 Educacion_{zi}+\beta_6 Riego_i\\
&+\beta_7 Fertilizante_i+\beta_8 Plaguicida_i+\varepsilon_i.
\end{aligned}
$$

$Y_i$ representa alternativamente productividad de la tierra o del trabajo. Arrendamiento/aparcería es la referencia de tenencia. El diagnóstico de Breusch-Pagan documentado en el Capítulo VII rechaza la homocedasticidad; por ello, la inferencia OLS utiliza errores estándar robustos HC1. Los coeficientes de las variables dicotómicas y de tenencia son diferencias condicionadas respecto de sus categorías de referencia, no efectos causales.
...
Antes de interpretar los modelos se verifican completitud, rango de la matriz de diseño, multicolinealidad y heterocedasticidad. El Capítulo VII reporta el factor de inflación de la varianza (VIF), prueba de Breusch-Pagan y evaluación gráfica de residuos. La significancia se acompaña de magnitud y dirección de los coeficientes; no se equipara significancia estadística con relevancia causal o de política.
